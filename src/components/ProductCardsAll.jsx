...
class ProductCardsAll extends Component {
    state = {
        product: [
            {
                id: 2,
            ...
            <section style={{ backgroundColor: "#eee" }} ClassName="">
                <div className="container py-5 pt-4  ">
                    ...
                    <div className="row">
                        ...
                        (
                            <ProductCardSmall key={index} productName={p.productName} count={p.count} price={p.price} offPrice={p.offPrice} rate={p.rate} category={p.category} />
                        ))
                        }
                    </div>
                </div>
